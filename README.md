...
Producing this certificate is a computationally hard and complex challenge. This is what Proof of Work is all about. We will go more in depth about this in a later tutorial, but for now, just know that producing this certificate is quite hard.
...
2. The transaction is broadcast to the Ethereum network through a node
